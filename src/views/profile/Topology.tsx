...
import TopologyCard from '@views/profile/TopologyCard'
    ...
    <>
      ...
      <Stack flexWrap={`wrap`} className={``} direction="row">
        <TopologyCard
          to={'hello'}
          title={'hello'}
          content="实验室设备资产管理方案主要由UHF无源标签、有源智能感应标签、UHF固定式读写器、有源固定式读写器、桌面发卡器、PDA以及实验室管理系统等组成，实现实验室设备资产的出入库、使用、借调、折旧、维修、报废、盘点、定位等日常化智能管理。"
          create_timestamp={0}
